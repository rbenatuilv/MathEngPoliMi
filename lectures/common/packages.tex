...
\titleformat{\chapter}[display]
  ...
  {\large\chaptertitlename\ \thechapter} % Texto que aparece antes del título
  {5pt} % Espacio entre el título y el capítulo
  {\huge} % Estilo del título
  [\vspace{2pt} \rule{\textwidth}{1pt}] % Línea horizontal después del título